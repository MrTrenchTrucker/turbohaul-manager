...
//
// When BE adds/changes a flag, update here too. Future Wave: codegen this
// from Python via a build step (Architecture Brainstormer Approach A — codegen)
...
export const FLAGS_SCHEMA: readonly FlagSpec[] = [
  ...
  // === Performance ===
  {
    ...
    default: -1,
    bounds: [-1, 256],
    hint: "CPU threads for inference. -1 = auto. Match physical core count.",
  },
  {
    name: "threads_batch",
    type: "int",
    ...
    default: -1,
    bounds: [-1, 256],
    hint: "CPU threads for batch processing. Defaults to threads if -1.",
  },
  {
    name: "threads_http",
    type: "int",
    ...
    default: -1,
    bounds: [-1, 256],
    hint: "HTTP server thread pool size.",
  },
  {
    name: "parallel",
    type: "int",
    ...
    default: -1,
    bounds: [1, 256],
    hint: "Number of parallel slots. Turbohaul uses 1 (serial).",
  },
  {
    name: "batch_size",
    type: "int",
    ...
    default: 2048,
    bounds: [1, 65536],
    hint: "Logical batch size (tokens).",
  },
  {
    name: "ubatch_size",
    type: "int",
    ...
    default: 512,
    bounds: [1, 65536],
    hint: "Physical microbatch size. Affects throughput vs. memory.",
  },
  {
    name: "keep",
    type: "int",
    ...
    default: 0,
    bounds: [-1, 65536],
    hint: "Tokens to retain at start of context (system prompt).",
  },
  {
    name: "flash_attn",
    type: "bool-or-enum",
  ...
  },
  {
    ...
    category: "Performance",
    default: false,
    hint: "Lock model in RAM (mlock). Prevents OS paging.",
  },
  {
    name: "no_mmap",
    type: "bool",
    category: "Performance",
    default: false,
    hint: "Disable mmap of model file. Forces full RAM load.",
  },
  {
    name: "numa",
    type: "enum-string",
    category: "Performance",
    default: "none",
    enumValues: ["none", "distribute", "isolate", "numactl"],
    hint: "NUMA placement strategy.",
  },
  {
    name: "swa_full",
    type: "bool",
    category: "Performance",
    default: false,
    hint: "Full SWA (sliding window attention) cache.",
  },
  {
    name: "no_perf",
    type: "bool",
  ...
  },
  {
    ...
    default: -1,
    bounds: [-1, 86400],
    hint: "Sleep server when idle for N seconds. -1 = never.",
  },
  {
    name: "cache_reuse",
    type: "int",
    ...
    default: 0,
    bounds: [0, 65536],
    hint: "KV cache reuse window (tokens).",
  },
  {
    ...
    category: "Performance",
    default: false,
    hint: "Disable context shifting when full. Stops on overflow instead.",
  },
  {
    ...
    default: 0.1,
    bounds: [0.0, 1.0],
    hint: "Min similarity for slot prompt re-use (0-1).",
  },
  {
    name: "warmup",
    type: "bool",
  ...
  },
  {
    ...
    category: "Performance",
    default: false,
    hint: "Verify tensor checksums at load.",
  },
  {
    name: "repack",
    type: "bool",
    category: "Performance",
    default: true,
    hint: "Repack tensors for current hardware.",
  },
  {
    name: "op_offload",
    type: "bool",
    category: "Performance",
    default: true,
    hint: "Offload supported ops to GPU.",
  },
  {
    name: "no_host",
    type: "bool",
    category: "Performance",
    default: false,
    hint: "Disable host buffer usage.",
  },
  {
    name: "direct_io",
    type: "bool",
    category: "Performance",
    default: false,
    hint: "Use O_DIRECT for model file reads.",
  },
  {
    name: "cont_batching",
    type: "bool",
    category: "Performance",
    default: true,
    hint: "Continuous batching across requests.",
  },
  ...
  },
  {
    ...
    category: "KV Cache",
    default: true,
    hint: "Unified KV cache layout (auto by default).",
  },
  {
    ...
    category: "KV Cache",
    default: true,
    hint: "Keep idle slot KV in cache.",
  },
  {
    name: "cache_prompt",
    type: "bool",
    category: "KV Cache",
    default: true,
    hint: "Cache prompt prefix across requests.",
  },
  {
    name: "cache_ram",
    type: "int",
  ...
  },
  {
    ...
    default: 32,
    bounds: [0, 1024],
    hint: "Number of context checkpoints to retain.",
  },
  {
    name: "checkpoint_every_n_tokens",
    type: "int",
    category: "KV Cache",
    default: 8192,
    bounds: [1, 1_000_000],
    hint: "Checkpoint cadence (tokens).",
  },
  ...
  // === Context / RoPE / YaRN (long-context tuning) ===
  {
    name: "rope_scaling",
    type: "enum-string",
    category: "Context / RoPE / YaRN",
    default: "linear",
    enumValues: ["none", "linear", "yarn"],
    hint: "RoPE scaling method.",
  },
  {
    name: "rope_scale",
    type: "float",
    ...
    default: 1.0,
    bounds: [0.0, 1000.0],
    hint: "RoPE frequency scale factor.",
  },
  {
    name: "rope_freq_base",
    type: "float",
    ...
    hint: "RoPE base frequency. 0 = use model default.",
  },
  {
  ...
  },
  {
    ...
    default: 0,
    bounds: [0, 2_000_000],
    hint: "YaRN original context size.",
  },
  {
    ...
    default: -1.0,
    bounds: [-1.0, 100.0],
    hint: "YaRN extrapolation factor.",
  },
  {
  ...
  // === MoE / Multi-GPU ===
  {
    name: "cpu_moe",
    type: "bool",
    category: "MoE / Multi-GPU",
    default: false,
    hint: "Put ALL MoE experts on CPU. For models too big for GPU. Slower.",
  },
  {
    name: "n_cpu_moe",
    type: "int",
    ...
    default: 0,
    bounds: [0, 256],
    hint: "Number of MoE expert layers on CPU. 0 = none. Use for partial offload to fit big MoE on small GPU.",
  },
  {
    name: "split_mode",
    type: "enum-string",
    category: "MoE / Multi-GPU",
    default: "layer",
    enumValues: ["none", "layer", "row", "tensor"],
    hint: "Multi-GPU split strategy.",
  },
  {
    name: "main_gpu",
    type: "int",
  ...
  },
  {
    ...
    default: "on",
    enumValues: ["on", "off"],
    hint: "Tom's Fork auto-mem-fit toggle.",
  },
  {
    name: "fit_ctx",
    type: "int",
    ...
    default: 4096,
    bounds: [1, 2_000_000],
    hint: "Tom's Fork fit-ctx target.",
  },
  ...
  },
  {
    ...
    default: 40,
    bounds: [0, 10000],
    hint: "Top-K sampling. 0 = disabled.",
  },
  {
    name: "top_p",
    type: "float",
  ...
  },
  {
    ...
    default: 1.0,
    bounds: [0.0, 1.0],
    hint: "Typical-P sampling (Ollama parity).",
  },
  {
    name: "top_n_sigma",
    type: "float",
    ...
    default: -1.0,
    bounds: [-1.0, 100.0],
    hint: "Top-N-sigma sampling. -1 = disabled.",
  },
  {
    name: "repeat_penalty",
    type: "float",
    ...
    default: 1.0,
    bounds: [0.0, 10.0],
    hint: "Repetition penalty. 1.0 = none.",
  },
  {
    name: "repeat_last_n",
    type: "int",
    ...
    default: 64,
    bounds: [-1, 65536],
    hint: "Window for repeat penalty (tokens).",
  },
  {
    ...
    default: 0.0,
    bounds: [-10.0, 10.0],
    hint: "Presence penalty (Ollama parity).",
  },
  {
    ...
    default: 0.0,
    bounds: [-10.0, 10.0],
    hint: "Frequency penalty (Ollama parity).",
  },
  {
    name: "seed",
    type: "int",
    category: "Sampling",
    default: -1,
    bounds: [-1, Number.MAX_SAFE_INTEGER],
    hint: "Random seed. -1 = random. BE enforces real int64 range.",
  },
  {
    name: "mirostat",
    type: "int",
    ...
    default: 0,
    bounds: [0, 2],
    hint: "Mirostat mode. 0=off, 1=v1, 2=v2.",
  },
  {
    name: "mirostat_lr",
    type: "float",
    ...
    default: 0.1,
    bounds: [0.0, 1.0],
    hint: "Mirostat learning rate (eta).",
  },
  {
    name: "mirostat_ent",
    type: "float",
    ...
    default: 5.0,
    bounds: [0.0, 100.0],
    hint: "Mirostat target entropy (tau).",
  },
  {
  ...
  },
  {
    ...
    default: 0.0,
    bounds: [0.0, 10.0],
    hint: "Dynamic temperature range.",
  },
  {
    name: "dynatemp_exp",
    type: "float",
    ...
    default: 1.0,
    bounds: [0.0, 10.0],
    hint: "Dynamic temperature exponent.",
  },
  {
    name: "dry_multiplier",
    type: "float",
    ...
    default: 0.0,
    bounds: [0.0, 10.0],
    hint: "DRY sampler multiplier. 0 = disabled.",
  },
  {
    name: "dry_base",
    type: "float",
  ...
  },
  {
    ...
    default: 2,
    bounds: [0, 65536],
    hint: "DRY allowed repeat length.",
  },
  {
  ...
  },
  {
    ...
    category: "Sampling",
    default: false,
    hint: "Ignore EOS token (model keeps generating).",
  },
  ...
  // === Reasoning (Hermes preserved-thinking) ===
  {
    ...
    category: "Reasoning",
    default: "auto",
    enumValues: ["none", "deepseek", "deepseek-legacy", "auto"],
    hint: "Reasoning output format (deepseek-r1 style).",
  },
  {
    name: "reasoning",
    type: "enum-string",
  ...
  // === Chat / Template ===
  {
    name: "chat_template",
    type: "chat-template",
    category: "Chat / Template",
    default: "default",
    enumValues: SAFE_CHAT_TEMPLATE_NAMES,
    hint: "Built-in template name OR plain string. Jinja constructs ({% / {{) REJECTED (F3 SSTI hardening).",
  },
  {
    name: "jinja",
    type: "bool",
    category: "Chat / Template",
    default: true,
    hint: "Enable Jinja template processing.",
  },
  {
    ...
    category: "Chat / Template",
    default: false,
    hint: "Skip chat-template parsing.",
  },
  {
    name: "special",
    type: "bool",
    category: "Chat / Template",
    default: false,
    hint: "Output special tokens (BOS/EOS/etc).",
  },
  {
    name: "spm_infill",
    type: "bool",
    category: "Chat / Template",
    default: false,
    hint: "SentencePiece infill mode.",
  },
  ...
  },
  {
    ...
    category: "Server",
    default: false,
    hint: "Enable /props endpoint (runtime mutate).",
  },
  {
    name: "embeddings",
    type: "bool",
    category: "Server",
    default: false,
    hint: "Enable /embeddings endpoint.",
  },
  {
    name: "reranking",
    type: "bool",
  ...
  },
  {
    ...
    category: "Server",
    default: "none",
    enumValues: ["none", "mean", "cls", "last", "rank"],
    hint: "Embedding pooling strategy.",
  },
  {
    name: "offline",
    type: "bool",
  ...
  },
  {
    ...
    category: "Debug",
    default: false,
    hint: "Prefix log lines with timestamp.",
  },
  {
    name: "log_timestamps",
    type: "bool",
    category: "Debug",
    default: false,
    hint: "Include timestamps in log lines.",
  },
  {
    name: "log_verbosity",
    type: "int",
    ...
    default: 3,
    bounds: [0, 4],
    hint: "Log verbosity level (0=silent, 4=trace).",
  },
];
