 ...
 * (in a future polish pass) fire a smoke chat-completion against the
 * sidecar directly.
 *
 * This page is author-only (no live POST UI); the `chatComplete` helper is
 * intentionally deferred to a follow-on change so this editor doesn't grow
