...
# Token-budget constants (envelope overhead subtracted upfront)
MAX_RESPONSE_TOKENS = 20_000  # hard cap on per-response token budget
...
def _decode_payload(payload_json: str | None) -> dict:
    """Best-effort JSON decode. Poison rows do not crash the request.
