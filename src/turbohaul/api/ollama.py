...
Phase 3 Wave 8 starts with the read-only endpoints (/api/tags, /api/show, /api/version
moved here from main.py is still served from main). The streaming completion routes
(/api/generate, /api/chat) come in Wave 9 with the httpx-proxy completion forwarding.
