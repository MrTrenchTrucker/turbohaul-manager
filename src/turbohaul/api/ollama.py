...
This module hosts the read-only endpoints (/api/tags, /api/show; /api/version
is still served from main.py). The streaming completion routes
(/api/generate, /api/chat) are handled via the httpx-proxy completion forwarding.
