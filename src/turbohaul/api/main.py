...
Per v0.2 ARCHITECTURE.md §9 + §11. Adds /ui static-file serving
...
# CSP modeled on a production-validated nginx.conf hardening profile.
    ...
    *,
    ...
    async def lifespan(app: FastAPI):
        ...
        if auto_start_worker:
            ...
            # Live inference monitor: single ~1Hz /slots poller (pure observer).
    ...
    async def get_config() -> dict:
        ...
        return {
            ...
            # paths would give a rebind-pivoting attacker the exact write
            # targets on disk. UI only needs basenames anyway.
            "storage": {
