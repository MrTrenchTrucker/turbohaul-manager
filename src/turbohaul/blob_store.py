"""Content-addressed blob storage per ARCHITECTURE.md.

Hardens against two security issues (blob TOCTOU + disk-fill DoS):
...
def verify_blob_on_stage(blobs_root: Path, expected_sha256: str) -> bool:
    """Re-verify blob hash at stage time. Defends against TOCTOU swap (per ARCHITECTURE.md).
