...
# Legal transitions per ARCHITECTURE.md.
...
LEGAL_TRANSITIONS: dict[SlotState, set[SlotState]] = {
    ...
    # alternating-pattern bug observed under a rapid same-thread burst.
    SlotState.STAGED: {SlotState.LOADING, SlotState.COLD, SlotState.ACTIVE_MATCH},
    SlotState.LOADING: {SlotState.ACTIVE, SlotState.LOADING_FAIL, SlotState.COLD},  # +COLD: a load can be cold-cancelled before it goes ACTIVE
