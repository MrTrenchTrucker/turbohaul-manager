...
Per Security Reviewer #58 F3 CRITICAL must-fix. Defends against:
  - http/file/ftp/gopher/dict/ldap/data scheme abuse → https-only
  - Internal fleet endpoints (Talk, RBSRS, IMDS) → IP allowlist via denyset
  - NAT64 64:ff9b::/96 + IPv4-compat IPv6 ::/96 (RC-D7EFD0 bypass classes)
