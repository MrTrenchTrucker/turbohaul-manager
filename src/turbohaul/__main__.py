...
(per ARCHITECTURE.md); the public-bind override only changes the uvicorn host argument,
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument(
        ...
        help=(
            ...
            "Default is 127.0.0.1; enable only inside an "
...
def main(argv: list[str] | None = None) -> int:
    ...
    uvicorn.run(
        ...
        access_log=True,
        # No --reload in production; see ARCHITECTURE.md deployment notes.
    )
    return 0
