...
Covers the 10 cases for the tool-calls feature:
...
def _build_app(tmp_path, fake_complete):
    ...
    # Path A fix: auto_start_worker=True so the FastAPI lifespan
...
# ===========================================================================
# (b) outbound reshape + multi-tool batch + empty-list omitted (collapsed)
# ===========================================================================
