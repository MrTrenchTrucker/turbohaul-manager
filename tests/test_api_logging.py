...
13 cases: 11 core behavior cases + 2 hostile-input edge cases (poison-row + list traversal).
"""
import json
...
# ============================================================================
# Case 12 — NEW: Poison row decode failure → sentinel, not 500
# ============================================================================
...
# ============================================================================
# Case 13 — NEW: Redaction list traversal scrubs nested prompts inside list
# ============================================================================
...
def test_get_logging_returns_200_without_authorization_header(app_test):
    ...
    perimeter-model documentation should be updated in the same change.
    """
    app, client = app_test
    r = client.get("/v1/logging")
    assert r.status_code == 200
